...
return [
    ...
    'upload' => [
        ...
        'imagePathFormat' => '/images/{yyyy}{mm}{dd}/', /* 上传保存路径,可以自定义保存路径和文件名格式 */
        ...
        'scrawlPathFormat' => '/images/{yyyy}{mm}{dd}/', /* 上传保存路径,可以自定义保存路径和文件名格式 */
        ...
        'snapscreenPathFormat' => '/images/{yyyy}{mm}{dd}/', /* 上传保存路径,可以自定义保存路径和文件名格式 */
        ...
        'catcherPathFormat' => '/images/{yyyy}{mm}{dd}/', /* 上传保存路径,可以自定义保存路径和文件名格式 */
        ...
        'videoPathFormat' => '/images/{yyyy}{mm}{dd}/', /* 上传保存路径,可以自定义保存路径和文件名格式 */
        ...
        'filePathFormat' => '/images/{yyyy}{mm}{dd}/', /* 上传保存路径,可以自定义保存路径和文件名格式 */
